...
import 'package:we_work/domain/permission/i_permission_service.dart';
...
class PermissionCubit extends Cubit<PermissionState> {
  ...
  PermissionCubit(this._permissionService, this._applicationLifeCycleCubit)
    ...
    _permissionService
      ...
      log('isLocationPermissionGranted $isLocationPermissionGranted');
      emit(state.copyWith(
    ...
    _permissionService
      ...
      log('isLocationServicesEnabled $isLocationServicesEnabled');
      emit(
